...
#————————————Start puck detection on s key—————————————————
        def puckDetection(key, tick,GameScreen):
        ...
        def pygameInit():
            ...
            pygame.draw.rect(screen, table_colour, pygame.Rect(0,10,1050,180))
        ...
        def pygameLoop(pygameArrayRed,pygameArrayBlue, screen):
            ...
            for x in pygameArrayRed:
                xpos = x.split(",")[0]
                ypos = x.split(",")[1]
                drawX = float(xpos) * 0.35
                drawY = float(ypos) * 0.5 
                ...
                pygame.draw.circle(screen, (255,0,0),[int(drawY), int(drawX)], 4, 0) 
            for x in pygameArrayBlue:
                ...
                if drawY < 80: 
                    ...
                    blueScore += 1
                pygame.draw.circle(screen, (0,0,255),[int(drawY), int(drawX)], 4, 0)     
            
            pygame.draw.line(screen, (0,0,0), (80,10),(80,190), 1)
            pygame.draw.line(screen, (0,0,0), (220,10),(220,190), 1)
            pygame.draw.line(screen, (0,0,0), (350,10),(350,190), 1)
            pygame.draw.line(screen, (0,0,0), (450,10),(450,190), 1)
        ...
        while True:
            ...
            if key == 115: #key "s"
                ...
                tick = 0
                puckDetection(key, tick, GameScreen) 
